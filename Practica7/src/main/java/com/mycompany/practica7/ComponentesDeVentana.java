...
class ComponentesDeVentana extends JPanel implements ActionListener
{
	...
	public ComponentesDeVentana(int anchura, int altura)
	{
		...
		tituloDentroDeGUI.setForeground(new Color(0,0, 0));
		...
		cocinero.setForeground(new Color(0, 0, 0));
		add(cocinero);
		...
		acciones.setForeground(new Color(0, 0, 0));
		add(acciones);
